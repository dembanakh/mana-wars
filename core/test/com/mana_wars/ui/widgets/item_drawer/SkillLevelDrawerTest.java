...
public class SkillLevelDrawerTest {
    ...
    public void testDraw() {
        ...
        when(skill.getLevel()).thenReturn(2);
        TextureRegion region = mock(TextureRegion.class);

        SkillLevelDrawer drawer = new SkillLevelDrawer(region);
        drawer.draw(batch, font, 0, skill, 0, 0, 100, 100);

        verify(font).draw(batch, "2", -100, 1, 0, 1, 200,
                Align.center, false, "");
    }

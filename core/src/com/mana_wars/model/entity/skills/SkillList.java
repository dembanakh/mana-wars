...
public class SkillList {
    ...
    static Map<Rarity,List<Skill>> createList(){
        ...
        commonList.add(new Skill(1,"image_part",Rarity.COMMON,5,"attack", skillCharacteristicList));
        ...
        commonList.add(new Skill(1,"image_part",Rarity.COMMON,5,"cure", skillCharacteristicList));
        skillCharacteristicList.clear();
        ...
        commonList.add(new Skill(1,"image_part",Rarity.RARE,5,"attack", skillCharacteristicList));
        skillCharacteristicList.clear();
        ...
        commonList.add(new Skill(1,"image_part",Rarity.RARE,5,"cure", skillCharacteristicList));
